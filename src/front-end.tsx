...
export default function FrontEnd (props: FEProp) : JSX.Element {
    ...
    <br />
    <p> Allows you to search through the worlds countries, and mark them as visted or want to visit</p>
    <hr />
    <a href = "https://baby-names-katrina.netlify.app/"> Baby Names </a>
    <p> Search and filter baby names based on gender, select and de-select your favourites !</p>
    </div>
    </>)
}