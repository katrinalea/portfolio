      ...
      <div className="page">
        ...
        <div className="grid-container">
          <div className="items">
            ...
            <p>
              {" "}
              Allows you to search through the worlds countries, and mark them
              as visted or want to visit.
            </p>
            <a href="https://github.com/katrinalea/countrys-API">
              {" "}
              GitHub Repo
            </a>
          </div>
          ...
          <div className="items">
            <a href="https://benevolent-praline-0fd986.netlify.app/">
              {" "}
              TV Shows{" "}
            </a>
            <p>
              {" "}
              Search and filter TV shows, select a show to look at it's
              episodes! This was a collaborative project in a team of two.
            </p>
